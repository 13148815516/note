...
public class ClassTransformerTest {
    public static void main(String[] args) throws Exception {
        ...
        //Class c = cl.loadClass("designPatternCode.ASM.Tank");
        cl.loadClass("designPatternCode.ASM.TimeProxy");
        Class c2 = cl.defineClass("designPatternCode.ASM.Tank", b2);
